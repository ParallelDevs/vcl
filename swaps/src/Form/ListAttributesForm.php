 ...
 * Contribute form.
 */
class ListAttributesForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'swap_list_attributes_form';
  }
  /**
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['swaps_attributes']['swaps_list_type'] = array(
      '#type' => 'select',
      '#title' => 'Type',
      '#options' => $options,
      '#default_value' => '1',
  ...
  public function ajaxSubmit(array &$form, FormStateInterface $form_state) {
    ...
    $settings['type'] = $input['swaps_list_type'];

    SwapDefaultAttributes::getDefaultFormElementsValues($settings, $input, 'swap_list');
